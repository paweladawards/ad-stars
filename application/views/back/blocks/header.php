<!-- ########## START: LEFT PANEL ########## -->
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <?php if($this->uri->segment(2) == 'glowna_baner'){echo 'active show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <a href="#" class="br-menu-link
        <?php if($this->uri->segment(2) == 'ofirmie_ikony' || $this->uri->segment(2) == 'ofirmie_sekcja_1' || $this->uri->segment(2) == 'ofirmie_sekcja_2' || $this->uri->segment(2) == 'ofirmie_sekcja_3'){echo 'active show-sub';} ?>">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>panel/ofirmie_sekcja_3" class="nav-link <?php if($this->uri->segment(2) == 'ofirmie_sekcja_3'){echo 'active';} ?>">
              Sekcja trzecia
            </a>
          </li>
        </ul>
    ...
    <div class="br-sideright">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="settings" role="tabpanel">
          ...
          <div class="pd-y-20 pd-x-25 tx-white">
            <h6 class="tx-13 tx-normal">Kolor trzeciorzędny:</h6>
            <div class="pos-relative">
              <input type="color" id="third_color" name="third_color" onchange="updateField('third_color' , 'settings')" value="<?php echo $settings->third_color; ?>" class="form-control form-control-inverse transition pd-y-5">
            </div>
          </div>

          <div class="pd-y-20 pd-x-25 tx-white">
            <h6 class="tx-13 tx-normal">Kolor czcionki:</h6>
            <div class="pos-relative">
              <input type="color" id="font_color" name="font_color" onchange="updateField('font_color' , 'settings')" value="<?php echo $settings->font_color; ?>" class="form-control form-control-inverse transition pd-y-5">
            </div>
          </div>

          <div class="pd-y-20 pd-x-25 tx-white">
            <h6 class="tx-13 tx-normal">Kolor czcionki alternatywny:</h6>
            <div class="pos-relative">
              <input type="color" id="font_color_alt" name="font_color_alt" onchange="updateField('font_color_alt' , 'settings')" value="<?php echo $settings->font_color_alt; ?>" class="form-control form-control-inverse transition pd-y-5">
            </div>
          </div>
